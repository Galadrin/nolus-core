...
// Minting formula f(x)=-4.33275 x^3 + 952.82456 x^2 - 88567.49981 x + 3.86381×10^6 integrated over 0.47 to 96
...
var (
	...
	cubeCoef           = sdk.MustNewDecFromStr("317.608")
	squareCoef         = sdk.MustNewDecFromStr("-44283.7")
	coef               = sdk.MustNewDecFromStr("3863810")
...
// Integral:  -1.08319 x^4 + 317.608 x^3 - 44283.7 x^2 + 3.86381×10^6 x
