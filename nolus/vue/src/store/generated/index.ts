...
import CosmzoneNolusCosmzoneNolusNolus from './cosmzone/nolus/cosmzone.nolus.nolus'
...
export default { 
  ...
  CosmzoneNolusCosmzoneNolusNolus: load(CosmzoneNolusCosmzoneNolusNolus, 'cosmzone.nolus.nolus'),
