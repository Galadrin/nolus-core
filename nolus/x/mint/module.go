...
import (
	...
	"encoding/json"
	"fmt"
	"gitlab-nomo.credissimo.net/nomo/cosmzone/nolus/x/mint/client/rest"
	"math/rand"
	...
	"gitlab-nomo.credissimo.net/nomo/cosmzone/nolus/x/mint/client/cli"
	"gitlab-nomo.credissimo.net/nomo/cosmzone/nolus/x/mint/keeper"
	"gitlab-nomo.credissimo.net/nomo/cosmzone/nolus/x/mint/simulation"
