...
import CosmzoneIgniteCosmzoneIgniteIgnite from './cosmzone/ignite/cosmzone.ignite.ignite'
...
export default { 
  ...
  CosmzoneIgniteCosmzoneIgniteIgnite: load(CosmzoneIgniteCosmzoneIgniteIgnite, 'cosmzone.ignite.ignite'),
